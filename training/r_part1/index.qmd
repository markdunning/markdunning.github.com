...
date: 2025-10-16
theme: darkly
description: "In these materials, we explore fundamental operations of R and load some example data"
---
...
Your output should be like that shown above - indicating that all required packages are present. 🎉We will cover the purpose of R packages to extend the default R functionality later.
...
![](https://aberdeenstudygroup.github.io/studyGroup/lessons/SG-T2-JointWorkshop/tidyverse.png) *Image Credit:* [***Aberdeen Study Group***](https://aberdeenstudygroup.github.io/studyGroup/lessons/SG-T2-JointWorkshop/PopulationChangeSpeciesOccurrence/)
...
In [Part 2](/training/r_part2/index.html) we will start to interrogate and visualise the data we have just imported
