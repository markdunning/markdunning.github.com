...
We will not be working with the datasets of packages we downloaded just yet, as we need to cover some fundamentals first
...
`Users/mark/Documents/workflows/workshops/r-crash-course/raw_data/gapminder.csv` **be a bad idea?** Would you be able to re-run the analysis on another machine?
...
In [Part 2](/training/part2) we will start to interrogate and visualise the data we have just imported
