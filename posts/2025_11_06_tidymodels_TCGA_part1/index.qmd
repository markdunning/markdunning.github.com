...
::: callout-note
If you would prefer a purely data-driven approach that doesn't use any prior knowledge you could instead use the result of `keep_variable` as your filtered object.
