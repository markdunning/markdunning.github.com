...
ggplot(er_train_simple, aes(x = ESR1, y = TFF1, col = ER)) + geom_point() + geom_point(data=(new_sample), col="black", size=3, stroke = 2)
```
...
ggplot(er_train_simple, aes(x = ESR1, y = TFF1, col = ER)) + geom_point() + 
  geom_point(data=(new_sample),col="black", size=3, stroke = 2) +
  geom_point(data=(nearest_training_samples), shape =4,col="steelblue", size=4, stroke = 2,alpha=0.6)
```
...
ggplot(er_train_simple, aes(x = ESR1, y = TFF1, col = ER)) + geom_point() + 
  geom_point(data=(edge_case), size = 3,col="black") +
  geom_point(data=(nearest_training_samples), shape =4,col="steelblue", size=4,stroke=2,alpha=0.6) 
```
